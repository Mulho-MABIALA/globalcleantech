...
exports.sendCandidatureAdminMail = sendCandidatureAdminMail;
exports.sendDemandeAdminMail = sendDemandeAdminMail;
exports.sendMessageAdminMail = sendMessageAdminMail;
exports.sendStatutUpdateMail = sendStatutUpdateMail;
exports.sendDemandeConfirmationMail = sendDemandeConfirmationMail;
...
async function sendCandidatureAdminMail(data) {
    const postes = {
...
async function sendDemandeAdminMail(data) {
    const services = {
...
async function sendMessageAdminMail(data) {
    await transporter.sendMail({
        from: FROM,
        to: ADMIN,
...
async function sendStatutUpdateMail(data) {
    const labels = {
...
async function sendDemandeConfirmationMail(to, nom, service) {
    await transporter.sendMail({
        from: FROM,
        to,
