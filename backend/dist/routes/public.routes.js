...
router.get('/content/:cle', async (req, res) => {
...
router.get('/candidature/statut', async (req, res) => {
...
router.post('/contact', async (req, res) => {
    const { nom, email, telephone, sujet, corps } = req.body;
    ...
    try {
        ...
        (0, mail_service_1.sendMessageAdminMail)({ id: message.id, nom, email, telephone, sujet, corps }).catch(() => { });
