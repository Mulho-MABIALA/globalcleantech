          ...
          <div className="grid grid-cols-1 lg:grid-cols-5">
            ...
            <div className="lg:col-span-2 bg-gradient-to-br from-primary to-primary-dark p-6 sm:p-8 text-white">
              ...
              <div className="space-y-4">
                {([
                  { icon: <path strokeLinecap="round" strokeLinejoin="round" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z M15 11a3 3 0 11-6 0 3 3 0 016 0z"/>, text: 'Quartier Sampathé, Thiès' },
                  {
