...
const CHANNELS = [
  {
    label: 'Email',
    value: 'contact@globalcleantechsn.com',
    href: 'mailto:contact@globalcleantechsn.com',
    color: '#1A7F4B',
    icon: (
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
              ...
              <ul className="space-y-3 text-sm text-muted">
                <li className="flex items-start gap-3">
                  ...
                  <span>Quartier Sampathé, Thiès, Sénégal<br /><span className="text-xs text-muted/70">Région de Thiès</span></span>
                </li>
                <li className="flex items-center gap-3">
                  <svg className="w-4 h-4 text-primary shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>
                  <span className="space-x-2">
                    <a href="tel:+221756422600" className="hover:text-primary transition-colors">+221 75 642 26 00</a>
                    <span>·</span>
                    <a href="tel:+221773501825" className="hover:text-primary transition-colors">+221 77 350 18 25</a>
                  </span>
                </li>
                <li className="flex items-center gap-3">
                  ...
                  <a href="mailto:contact@globalcleantechsn.com" className="hover:text-primary transition-colors">contact@globalcleantechsn.com</a>
                </li>
                <li className="flex items-center gap-3">
                  ...
                  <span>Lun–Ven, 9h–18h · Sam, 10h–17h</span>
                </li>
              </ul>
            </div>
